...
export class Home2Component {
  ...
  thumbsSwiper: unknown;
    ...
    activeTab = 'vente-location';

    setActiveTab(tab: string): void {
      this.activeTab = tab;
    }
    venteButtonColor: string = 'black';
    locationButtonColor: string = 'black';
  
    toggleVenteButtonColor() {
      this.venteButtonColor = this.venteButtonColor === 'black' ? 'blue' : 'black';
    }
  
    toggleLocationButtonColor() {
      this.locationButtonColor = this.locationButtonColor === 'black' ? 'blue' : 'black';
    }
 slidesStore = [
    {
      id:"1",
